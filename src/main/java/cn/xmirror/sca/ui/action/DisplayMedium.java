 ...
 **/
public class DisplayMedium extends DumbAwareToggleAction {
    ...
    public boolean isSelected(@NotNull AnActionEvent event) {
        ...
        Boolean displayingErrors = ToolWindowAccess.getOverViewPanel(project, OverviewPanel::isDisplayingMedium);
    ...
    public void setSelected(@NotNull AnActionEvent event, boolean selected) {
        ...
        ToolWindowAccess.getOverViewPanel(project,panel ->{
            panel.setDisplayingMedium(selected);
