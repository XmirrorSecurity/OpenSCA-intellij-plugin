 ...
 **/
public class DisplayHigh extends DumbAwareToggleAction {
    ...
    public boolean isSelected(@NotNull AnActionEvent event) {
        ...
        Boolean displayingErrors = ToolWindowAccess.getOverViewPanel(project, OverviewPanel::isDisplayingHigh);
    ...
    public void setSelected(@NotNull AnActionEvent event, boolean selected) {
        ...
        ToolWindowAccess.getOverViewPanel(project,panel ->{
            panel.setDisplayingHigh(selected);
